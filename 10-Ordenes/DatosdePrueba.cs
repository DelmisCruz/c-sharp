...
public class DatosdePrueba
{
    ...
    {
        Cliente c1 = new Cliente(1, "Maria", "3359-6020");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "Veronica", "9959-0028");
        ListadeClientes.Add(c2);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Mauricio", "V001");
        ListadeVendedores.Add(v1);

        Vendedor v2 = new Vendedor(2, "Rosiris", "V002");
